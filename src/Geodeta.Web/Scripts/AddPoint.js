                ...
                for (var i = 0, I = markers.length; i < I && markers[i] != marker; i++) {
                    if (i < markers.length - 1) {
                        if (i > 0) {
                            ...
                            var boxText = '<div class="titleInfoBox"><div style="float:left"><button type="button" class="btn btn-default btn-circle" onClick="openModalAddNoteLines()" style="margin:left:5px;margin-right:5px"><i class="glyphicon glyphicon-plus"></i></button></div></div>' + '<div class="textInfoBox">' + "Brak notatki" + '</div>';
                            line.infobox = new InfoBox({
                                content: boxText,
